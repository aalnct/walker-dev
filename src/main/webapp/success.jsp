...
<title>Welcome <c:out value="${messages}"></c:out>
</title>
<script type="text/javascript">
			...
			$( ".dropdown-menu li a[rel=profileupdate]" ).on( "click", function(response) {
					  ...
					  $.ajax({
				    	 	...
				    	 	url:'/walker/updateUserInformation/',
				   			...
				   			success :function(response) {
				   				...
				   				$("#emailid").val(obj.emailAddress);
				   				$("#username").val(obj.username);
				   				$("#dateofbirth").val(obj.dob);
				   				$("#City").val(obj.address.city);
				   				$("#State").val(obj.address.state);
				   				$("#zipCode").val(obj.address.zipcode);
				   				$("#add1").val(obj.address.addressLine1);
				   				$("#add2").val(obj.address.addressLine2);
				   				$("#add3").val(obj.address.addressLine3);
				   				
				   		},
				   			error :function(response){
				   				alert('Response Error from Server!! Hangon while we check');
				   			},
				      });
	...
	<div id="dialog-form" title="Create new user">
		<form>
						...
						<div class="page-header" style="margin-left: 55px;">
							...
							<ul class="nav navbar-right">
								<li class="dropdown"><a href="#"
									...
									role="button" aria-expanded="false"> Settings <span
										class="caret"></span></a>

									<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
										<li role="updatePassword"><a href="#"
											rel="passwordContainer">Change Password</a></li>
											<!-- editProfile -->
										<li role="profileupdate"><a href="javascript:void(0)" rel="profileupdate">Edit Profile</a></li>
										<li role="logout"><a href="javascript:void(0)"
											rel="logout">Logout</a></li>
										<li class="divider"></li>
										<li class="dropdown-submenu pull-left" role="student"><a
											tabindex="-1" href="javascript:void(0)" rel="student">My
												Student Profile</a>
											<ul class="dropdown-menu">
												<li class="dropdown-submenu"><a
													href="javascript:void(0)">Student</a></li>
												<li class="dropdown-submenu"><a
													href="javascript:void(0)">Grades</a></li>
												<li class="dropdown-submenu"><a
													href="javascript:void(0)">Sports Team</a></li>
											</ul></li>
    		...
    		${emptyList} 
							...
							<h3 class="text-center login-title">Enter following
								information</h3>
						</div>
						...
						<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="panel panel-default">
									...
									<%@include file="/profileupdate.jsp"%>
									...
									<div id="bmicalculator" class="panel-control">
										...
										<div class="panel-body">
											<div class="form-group">
												<label> Age </label> <input type="text" id="age" value=""
													class="form-control" />
											...
											<div class="form-group">
												<label>BMI</label> <input type="text" class="form-control"
													value="${result}" id="bmiresult" placeholder="BMI" readonly />

											</div>
											<div class="form-group">
												<input type="button" name="bmi" id="bmi_calculate"
													value="Calculate" class="btn btn-lg btn-success" /> <input
													type="button" name="saveCalculation" id="saveCalculation"
													value="Save" class="btn btn-lg btn-success"
